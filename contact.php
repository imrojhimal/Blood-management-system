	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2">Connect with the blood bank today and become a beacon of hope.</p> 
				<p class="mt-2">Your information can bridge the gap between life and a second chance.</p>
				<p class="mt-2"> Join us in the mission to save lives through the power of giving.</p>
			</div>
			<div class="d-flex">
