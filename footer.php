          ...
          <div class="col-md-4 w3l-footer">
            <h2 class="mb-sm-3 mb-2">
              <a href="index.php" class="text-white font-italic font-weight-bold">
                <span>Blood </span> Management System 
                <i class="fas fa-syringe ml-2"></i>
              </a>
            </h2>
            <p>"Every drop you give today is a lifeline for someone tomorrow. Be a hero "-" Donate blood and save a life."</p>
          </div>
...
{ ?>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="mb-sm-3 mb-2 text-white"> Blood  Management System project By <a href="https://www.linkedin.com/in/imroj-ahasan-himal-195a25194/">Imroj Ahasan Mojumder</a>
